...
class Login
{
    ...
    public function __construct()
    {
        ...
        } elseif (isset($_POST["loginCN"])) {
            if (!isset($_POST['user_rememberme'])) {
                $_POST['user_rememberme'] = null;
            }
            $this->loginWithPostData($_POST['usernameCN'], $_POST['passwordCN'], $_POST['user_rememberme']);
        }
        // if user just submitted a login form
        elseif (isset($_POST["loginEN"])) {
            if (!isset($_POST['user_rememberme'])) {
            $_POST['user_rememberme'] = null;
        }
            $this->loginWithPostData($_POST['usernameEN'], $_POST['passwordEN'], $_POST['user_rememberme']);
        }
    ...
    private function loginWithPostData($username, $password, $user_rememberme)
    {
        ...
        // if POST data (from login form) contains non-empty user_name and non-empty user_password
            ...
            //TODO refactor DB again to accommodate for these kind of things
            ...
            } elseif ($result_row->banned == 1){
                redirect_to(PATH_TO_VIEWS . 'login.php?error=' . USER_BANNED_ERROR_INDEX);
            }
            ...
            /*else if ($result_row->user_active != 1) {
                ...
                //TODO add user logged in into DB
                //$_SESSION['user_logged_in'] = 1;
                ...
                //TODO refactor DB and enable this
                ...
                //TODO refactor DB and update this
               ...
               /* if (isset($user_rememberme)) {
                ...
                //TODO refactor DB and see if that is needed
    ...
    public function editUserEmail($user_email)
    {
        ...
        // user mail cannot be empty and must be in email format
            ...
            //TODO error here with user_id; changed to user_id_
    ...
    public function checkIfEmailVerificationCodeIsValid($user_name, $verification_code)
    {
        ...
        if (empty($user_name) || empty($verification_code)) {
            ...
            if (isset($result_row->user_id_) && $result_row->user_password_reset_hash == $verification_code) {
