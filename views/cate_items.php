...
<body>
	...
	<div class="container" >
		<div class="row" align="center" style="background-image:url( '../images/carousel1.jpg');background-repeat:no-repeat; margin:auto; padding: 10% 0 10% 0;">
			<button type="button" class="btn btn-default btn-lg" style="color: black; opacity:0.7; font-family: Times New Roman; font-size: 35px">
				ITEMS
				<p>Find what you like</p>
			</button>
		</div>
		<br>
		<div class="row" align="center">
			<div class="menu">
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_items_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(CLOTHES)?>">
						<p style="background:url(../images/menu1.jpg);">CLOTHES</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_items_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(BOOKS)?>">
						<p style="background:url(../images/menu2.jpg);">BOOKS</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_items_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(ELECTRONICS)?>">
						<p style="background:url(../images/menu3.jpg);">ELECTRONICS</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_items_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(FURNITURE)?>">
						<p style="background:url(../images/menu4.jpg);">FURNITURE</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_items_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(GAMES)?>">
						<p style="background:url(../images/menu5.jpg);">GAMES</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_items_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(OTHER)?>">
						<p style="background:url(../images/menu6.jpg);">OTHER</p>
					</a>
				</div>
			</div>
		</div>
