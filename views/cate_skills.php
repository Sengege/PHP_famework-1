...
<header>
	...
	<div class="container" >
		<div class="row" align="center" style="background-image:url( '../images/carousel2.jpg');background-repeat:no-repeat; margin:auto; padding: 10% 0 10% 0;">
			<button type="button" class="btn btn-default btn-lg" style="color: black; opacity:0.7; font-family: Times New Roman; font-size: 35px">
				SKILLS
				<p>Exchange what you want</p>
			</button>
		</div>
		<br>
		<div class="row" align="center">
			<div class="menu">
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_skills_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(ACADEMIC)?>">
						<p style="background:url(../images/menu1.jpg);">ACADEMIC</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_skills_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(COMPUTER)?>">
						<p style="background:url(../images/menu2.jpg);">COMPUTER</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_skills_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(ARTISTIC)?>">
						<p style="background:url(../images/menu3.jpg);">ARTISTIC</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_skills_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(COOKING)?>">
						<p style="background:url(../images/menu4.jpg);">COOKING</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_skills_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(LANGUAGES)?>">
						<p style="background:url(../images/menu5.jpg);">LANGUAGES</p>
					</a>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<a href="cate_skills_cate.php?category_type_id=<?php echo $cat_type?>&sub_category_type_id=<?php echo urlencode(OTHER)?>">
